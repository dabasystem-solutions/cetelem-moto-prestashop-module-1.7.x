...
class CetelemPaymentModuleFrontController extends ModuleFrontController {
    ...
    public function initContent() {
        ...
        $this->context->smarty->assign(array(
           'conex_url' => (Configuration::get('CETELEM_ENV')) ? Cetelem::CETELEM_URL_CONNECTION : Cetelem::CETELEM_URL_TEST_CONNECTION,
    ...
    protected function OrderCreation()
    {
        ...
        $mailVars = array();
        return $this->module->validateOrder($cart->id, Configuration::getGlobalValue('PS_OS_CETELEM_STANDBY'), $total, $this->module->name, '', $mailVars, (int) $currency->id, false, $customer->secure_key);
    }
