...
<style type="text/css">
	{literal}
		div#eCalculadoraCetelemDiv *, #financiacionCtl, #importeMensualidadCtl, #infoFinanciacionCtl, #infoTextCalculator *, .label_financiacion, .label_cuota {
			color: {/literal}{$text_color} !important;{literal}
		}
		div.e_backgroundColorCtl, div.rangoCtl.e_backgroundColorIzdoCtl, div.rangoCtl.info {
			background-color: {/literal}{$background_color} !important;{literal};
			border: 1px solid {/literal}{$border_color} !important;{literal};
		}
		div.bloqueCuotaCtl {
			background-color: {/literal}{$background_color} !important;{literal};
		}
		div#infoFinanciacionCtl * {
			color: {/literal}{$fee_color} !important;{literal}
		}
	{/literal}
</style>
