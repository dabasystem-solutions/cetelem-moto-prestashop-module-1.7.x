    ...
    <dl>
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-6 sameheight1">
                <p><div id="calc_container"><div id="eCalculadoraCetelemDiv"></div></div></p>
        </div>
        <div class="col-xs-12 col-sm-6 sameheight2">
            ...
            <p class="text">
                ...
                <span>{l s='Y si ya eres cliente de Cetelem y tienes disponible en tu línea de crédito, aplazar del pago de tu compra será' mod='cetelem'}</span> <span style="text-decoration:underline;">{l s='inmediato' mod='cetelem'}</span>
            </p>
        </div>
       </div>
